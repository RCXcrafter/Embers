...
public class RecipeRegistry {
	...
	public static ArrayList<ItemMeltingRecipe> allMeltingRecipes = new ArrayList<ItemMeltingRecipe>();
	public static ArrayList<ItemMeltingOreRecipe> allMeltingOreRecipes = new ArrayList<ItemMeltingOreRecipe>();
	...
	public static void init(){
		...
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_gold,144),EnumStampType.TYPE_BAR,new ItemStack(Items.GOLD_INGOT,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_lead,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_lead,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_silver,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_silver,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_copper,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_copper,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_dawnstone,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_dawnstone,1),false,false));
		if (ConfigManager.enableAluminum){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_aluminum,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_aluminum,1),false,false));
		}
		if (ConfigManager.enableBronze){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_bronze,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_bronze,1),false,false));
		}
		if (ConfigManager.enableElectrum){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_electrum,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_electrum,1),false,false));
		}
		if (ConfigManager.enableNickel){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_nickel,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_nickel,1),false,false));
		}
		if (ConfigManager.enableTin){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_tin,144),EnumStampType.TYPE_BAR,new ItemStack(RegistryManager.ingot_tin,1),false,false));
		}
		
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_iron,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_iron,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_gold,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_gold,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_lead,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_lead,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_silver,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_silver,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_copper,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_copper,1),false,false));
		stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_dawnstone,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_dawnstone,1),false,false));
		if (ConfigManager.enableAluminum){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_aluminum,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_aluminum,1),false,false));
		}
		if (ConfigManager.enableBronze){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_bronze,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_bronze,1),false,false));
		}
		if (ConfigManager.enableElectrum){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_electrum,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_electrum,1),false,false));
		}
		if (ConfigManager.enableNickel){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_nickel,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_nickel,1),false,false));
		}
		if (ConfigManager.enableTin){	
			stampingRecipes.add(new ItemStampingRecipe(null,new FluidStack(RegistryManager.fluid_molten_tin,144),EnumStampType.TYPE_PLATE,new ItemStack(RegistryManager.plate_tin,1),false,false));
		}
		...
		alchemyRecipes.add(new AlchemyRecipe(24, 36, 0, 0, 0, 0, 0, 0, 0, 0, new ItemStack(Items.IRON_INGOT), new ItemStack(Items.QUARTZ), new ItemStack(Items.CLAY_BALL), new ItemStack(Items.DYE,1,4), null, new ItemStack(RegistryManager.isolated_materia,4)));
		alchemyRecipes.add(new AlchemyRecipe(12, 18, 0, 0, 0, 0, 0, 0, 0, 0, new ItemStack(Items.CLAY_BALL), new ItemStack(Items.DYE,1,15), new ItemStack(Items.DYE,1,15), null, null, new ItemStack(RegistryManager.adhesive,6)));
	...
	public static void postInit(){
		for (String recipeString : meltingOreRecipes.keySet()){
			allMeltingOreRecipes.add(meltingOreRecipes.get(recipeString));
		}
		
		for (ItemStack recipeStack : meltingRecipes.keySet()){
			allMeltingRecipes.add(meltingRecipes.get(recipeStack));
		}
	}
	...
	public static ItemMeltingRecipe getMeltingRecipe(ItemStack stack){
		for (int i = 0; i < allMeltingRecipes.size(); i ++){
			if (allMeltingRecipes.get(i).matches(stack)){
				return allMeltingRecipes.get(i);
			}
		}
		return null;
	}
	...
	public static ItemMeltingOreRecipe getMeltingOreRecipe(ItemStack stack){
		for (int i = 0; i < allMeltingOreRecipes.size(); i ++){
			if (allMeltingOreRecipes.get(i).matches(stack)){
				return allMeltingOreRecipes.get(i);
			}
		}
		return null;
	}
